#!/usr/bin/env python3
'''
simple templating system for pprzlink generator
...
class PPRZTemplate(object):
    ...
    def find_end(self, text, start_token, end_token, ignore_end_token=None):
        ...
        while nesting > 0:
            ...
            if idx1 == -1 and idx2 == -1:
                raise PPRZParseError("token nesting error")
    ...
    def substitute(self, text, subvars={},
        ...
        while True:
            ...
            if endidx == -1:
                raise PPRZParseError("missing end macro in %s" % text[subidx:])
            part1 = text[0:subidx]
            ...
            if v is None:
                raise PPRZParseError('unable to find field %s' % field_name)
            t1 = part1
            for f in v:
        ...
        while True:
            ...
            if endidx == -1:
                raise PPRZParseError('missing end of variable: %s' % text[idx:idx+10])
